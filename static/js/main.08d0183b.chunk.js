(this["webpackJsonpsearch-movies-react-hooks"]=this["webpackJsonpsearch-movies-react-hooks"]||[]).push([[0],{19:function(e,t,o){"use strict";let i;o.d(t,"a",(function(){return i})),function(e){e.SEARCH_REQUEST="@@movies/SEARCH_REQUEST",e.SEARCH_SUCCESS="@@movies/SEARCH_SUCCESS",e.SEARCH_ERROR="@@movies/SEARCH_ERROR"}(i||(i={}))},20:function(e,t){},21:function(e,t){},22:function(e,t){},44:function(e,t,o){"use strict";o.r(t);var i=o(2),n=o(12),r=o.n(n);Boolean("localhost"===window.location.hostname||"[::1]"===window.location.hostname||window.location.hostname.match(/^127(?:\.(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)){3}$/));var c=o(7),a=o(30),s=o(24),d=o(6),l=o(15),u=o(8);const b=e=>Object(l.action)(u.MoviesActionTypes.SEARCH_ERROR,e),j=Object({NODE_ENV:"production",PUBLIC_URL:"/search-movies-react-hooks",WDS_SOCKET_HOST:void 0,WDS_SOCKET_PATH:void 0,WDS_SOCKET_PORT:void 0,FAST_REFRESH:!0,REACT_APP_API_KEY:"4a3b711b"}).REACT_APP_API_ENDPOINT||"https://www.omdbapi.com/";function m(e,...t){return async function(e,t,o,i){return(await fetch(t,{method:e,headers:{Accept:"application/json"},body:JSON.stringify(o),signal:i})).json()}("get",function(e,...t){return`${e}?${t.join("&")}`}(j,"apiKey=4a3b711b",...t),void 0,e)}function*f(e){const t=new AbortController;try{const i=yield Object(d.b)(m,t.signal,`s=${e.payload}`);i.Error?yield Object(d.e)(b(i.Error)):0===i.Search.length?yield Object(d.e)(b("There are no movies found. Try another search request.")):yield Object(d.e)((o=i.Search,Object(l.action)(u.MoviesActionTypes.SEARCH_SUCCESS,o)))}catch(i){i instanceof Error&&i.stack?yield Object(d.e)(b(i.stack)):yield Object(d.e)(b("An unknown error occurred"))}finally{(yield Object(d.c)())&&t.abort()}var o}function*h(){yield Object(d.f)(u.MoviesActionTypes.SEARCH_REQUEST,f)}var p=function*(){yield Object(d.a)([Object(d.d)(h)])};const v={data:void 0,error:void 0,loading:!1},O=(e=v,t)=>{switch(t.type){case u.MoviesActionTypes.SEARCH_REQUEST:return{...e,loading:!0};case u.MoviesActionTypes.SEARCH_SUCCESS:return{...e,loading:!1,data:t.payload,error:void 0};case u.MoviesActionTypes.SEARCH_ERROR:return{...e,loading:!1,error:t.payload};default:return e}};function*x(){yield Object(d.a)([Object(d.d)(p)])}var g=o(9),y=o(4);const S=y.default.header`
...
`;function de(){return Object(i.jsxs)(i.Fragment,{children:[Object(i.jsx)(ae,{}),Object(i.jsx)(se,{})]})}var le=function({store:e}){return Object(i.jsxs)(g.a,{store:e,children:[Object(i.jsx)(de,{}),Object(i.jsx)(re,{})]})};const ue=function(e){const t=Object(s.composeWithDevTools)({}),o=Object(a.a)(),i=Object(c.createStore)(Object(c.combineReducers)({movies:O}),e,t(Object(c.applyMiddleware)(o)));return o.run(x),i}(window.INITIAL_REDUX_STATE);r.a.render(Object(i.jsx)(le,{store:ue}),document.getElementById("root")),"serviceWorker"in navigator&&navigator.serviceWorker.ready.then((e=>{e.unregister()})).catch((e=>{console.error(e.message)}))},8:function(e,t,o){"use strict";var i=o(19);o.d(t,"MoviesActionTypes",(function(){return i.a}));o(20),o(21),o(22)}},[[44,1,2]]]);
//# sourceMappingURL=main.08d0183b.chunk.js.map